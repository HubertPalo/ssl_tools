...
num_gpus = 1
strategy = "ddp"
checkpoint_dir = Path("save_models/preTrain/")
tfc_pretrain_checkpoint = checkpoint_dir
batch_size = 128

data_path = Path("standartized_balanced/" + dataset)
...
def get_data():
    ...
    X_train = dataset.iloc[:,:360]
    y_train = dataset["standard activity code"]
